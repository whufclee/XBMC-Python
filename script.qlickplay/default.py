...
class Main:
    ...
    def __init__(self):
        ...
        xbmc.executebuiltin('Skin.SetString(ExtendedColorMain,'+COLORMAIN+')')
        xbmc.executebuiltin('Skin.SetString(ExtendedColorThemed,'+COLORTHEMED+')')
        self._parse_argv()
        if self.infos:
